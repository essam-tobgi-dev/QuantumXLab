...
// `qlab.optimize`, `qlab.layout`, `qlab.routing`, `qlab.pulse_level`, `qlab.seed`, then the defaults
// of `CompileContext`. (`qlab.layout physical` is carried by the circuit itself.)
...
// `pragma qlab.schedule <policy> dt=<ns>ns`. The text re-imports and compiles to an equivalent circuit.
