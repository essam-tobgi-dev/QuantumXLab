...
class TextBatch {
  public:
    ...
    void label3D(const glm::dvec3& world, std::string_view utf8, float sizePx,
                 const glm::vec4& color, TextAnchor anchor = TextAnchor::BottomCenter,
                 glm::vec2 pixelOffset = {0, 0});
  ...
  private:
    void emit(const glm::vec3& anchor, std::string_view s, float sizePx, const glm::vec4& c,
