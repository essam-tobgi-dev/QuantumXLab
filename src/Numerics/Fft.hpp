...
// Power spectrum in dB relative to full scale of a windowed signal; returns (freq, dB) with `sampleRate`.
struct Spectrum { RealVector freqHz; RealVector powerDb; double enbwHz; };
