...
struct Blas {
    ...
    // C = alpha A B + beta C
    static void zgemm(ConstMatrixView A, ConstMatrixView B, MatrixView C, Complex alpha,
                      Complex beta);
    // Hermitian eigendecomposition: on success H_inout holds eigenvectors as COLUMNS, eigvals
    // ascending.
