...
#define QXL_LOG_INFO(cat, ...) ::qlab::core::log(::qlab::core::LogCat::cat, ::qlab::core::LogLevel::Info, __VA_ARGS__)
#define QXL_LOG_WARN(cat, ...) ::qlab::core::log(::qlab::core::LogCat::cat, ::qlab::core::LogLevel::Warn, __VA_ARGS__)
#define QXL_LOG_ERROR(cat, ...) ::qlab::core::log(::qlab::core::LogCat::cat, ::qlab::core::LogLevel::Error, __VA_ARGS__)
#define QXL_LOG_DEBUG(cat, ...) ::qlab::core::log(::qlab::core::LogCat::cat, ::qlab::core::LogLevel::Debug, __VA_ARGS__)

// Ring buffer of recent messages for the in-app Log panel (spec 19).
struct LogEntry { LogCat cat; LogLevel lvl; std::string text; double timeS; };
