...
constexpr std::array<std::string_view, 34> kKeywords = {
    "OPENQASM", "include",  "qubit",   "bit",           "gate",   "measure", "reset",
    "barrier",  "delay",    "if",      "else",          "for",    "in",      "while",
    "switch",   "case",     "default", "def",           "return", "extern",  "const",
    "input",    "output",   "let",     "box",           "cal",    "defcal",  "pragma",
    "break",    "continue", "end",     "defcalgrammar", "ctrl",   "negctrl"};
constexpr std::array<std::string_view, 12> kTypes = {"int",     "uint",  "float",    "angle",
                                                     "bool",    "bit",   "duration", "stretch",
                                                     "complex", "qubit", "qreg",     "creg"};
// π, τ and ε are the Unicode spellings of the built-in constants (spec 13 §1 keyword list).
constexpr std::array<std::string_view, 28> kBuiltins = {
    "pi",   "euler",  "tau",    "\xCF\x80", "\xCF\x84", "\xCE\xB5",   "sin",
    "cos",  "tan",    "arcsin", "arccos",   "arctan",   "exp",        "ln",
    "sqrt", "pow",    "mod",    "rotl",     "rotr",     "popcount",   "real",
    "imag", "sizeof", "inv",    "gphase",   "U",        "durationof", "im"};
constexpr std::array<std::string_view, 16> kPulse = {
    "port",      "frame",       "waveform",        "play",      "set_frequency", "shift_frequency",
    "set_phase", "shift_phase", "get_frequency",   "get_phase", "capture",       "capture_v2",
    "newframe",  "gaussian",    "gaussian_square", "drag"};
