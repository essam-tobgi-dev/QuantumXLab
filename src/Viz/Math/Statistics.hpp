...
struct HistogramOptions {
    ...
    std::vector<std::size_t> marginalBits; // non-empty: marginal over these bit indices (bit 0 = rightmost)
    double z = 1.0;
};
...
Result<HistogramModel> buildHistogram(const data::Histogram& counts, std::span<const double> ideal = {},
