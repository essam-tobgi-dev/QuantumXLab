...
Result<num::Matrix> reducedDensity(const qsim::Snapshot& snapshot, std::span<const std::uint32_t> qubits);
...
// The computational 2×2 block of a single-site state (not renormalised: leakage shortens the Bloch vector).
