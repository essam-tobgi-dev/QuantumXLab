...
// Derived exact
inline constexpr MagneticFlux Phi0{6.62607015e-34 / (2.0 * 1.602176634e-19)};          // h/2e = 2.067833848e-15 Wb
inline constexpr Resistance   R_K{6.62607015e-34 / (1.602176634e-19 * 1.602176634e-19)}; // h/e^2 = 25812.80745 Ω
...
// Derived helpers
inline constexpr Q<Dim<-1, 0, 0, 0, -1, 0, 0>> kB_over_h{1.380649e-23 / 6.62607015e-34}; // Hz/K = 20.8366 GHz/K
