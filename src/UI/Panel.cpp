...
constexpr std::array<PanelId, 8> kLabPanels{
    PanelId::Viewport, PanelId::Inspector, PanelId::ComponentTree, PanelId::Instruments,
    PanelId::Fridge,   PanelId::Project,   PanelId::Log,           PanelId::Tour};
constexpr std::array<PanelId, 8> kProgramPanels{
    PanelId::CodeEditor,  PanelId::Diagnostics, PanelId::Circuit,  PanelId::Pulses,
    PanelId::RunControls, PanelId::Results,     PanelId::Examples, PanelId::Log};
constexpr std::array<PanelId, 7> kAnalysisPanels{
    PanelId::StateViews, PanelId::Plots,  PanelId::Fits,       PanelId::Results,
    PanelId::Estimates,  PanelId::Theory, PanelId::Instruments};
...
std::string_view workspaceLabelKey(Workspace w) {
    ...
    case Workspace::Program:
        return "workspaces.program";
    case Workspace::Analysis:
        return "workspaces.analysis";
    case Workspace::Count:
        break;
    }
    return "workspaces.lab";
...
std::string Panel::title() const {
    return std::string(Strings::global().get(titleKey()));
}
