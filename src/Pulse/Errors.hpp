...
inline constexpr ErrorCode kErrNoDefcal  = ErrorCode::Pulse_ + 8;  // E_NO_DEFCAL: no calibration for (gate, qubits)
inline constexpr ErrorCode kErrSampling  = ErrorCode::Pulse_ + 9;  // sample rate / record problem
inline constexpr ErrorCode kErrDrive     = ErrorCode::Pulse_ + 10; // schedule → Hamiltonian drive conversion
inline constexpr ErrorCode kErrMsClosure = ErrorCode::Pulse_ + 11; // MS phase-space loop cannot be closed
