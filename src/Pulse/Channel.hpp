...
struct ChannelId {
    ...
    static ChannelId control(std::uint32_t c, std::uint32_t t) {
        return {ChannelKind::Control, c, t};
    }
    ...
    static ChannelId bichromatic(std::uint32_t i, std::uint32_t j) {
        return {ChannelKind::Bichromatic, i, j};
    }
